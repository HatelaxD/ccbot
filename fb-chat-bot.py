        ...
        try:
            if("search pdf" in msg):
                ...
                sendMsg()
                 ...
                 sendMsg() 
            elif ("frank hameed gandu" in msg):
                 reply = "roz gand mrwata ha"
                 sendMsg()  
...
cookies = {
    ...
    "xs": "39%3AdSbyORZ6oSehsA%3A2%3A1665594085%3A-1%3A6126%3A%3AAcX-Ak8Oyx_i0uEKk6KRsHdzScmYDUauYgxwcw5yXcI"
}
